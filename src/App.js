...
const App = () => {
  const portfolioData = {
    name: "JHA GAURAV",
    reg:"21BIT0429",
    place: "DAMAN , DD | India",
    skills: ["Cloud Practitione","Proficient in Java & C++", "Novice in Web Development(Mern)", "Intermediate in Database(mySQL & MongoDB)"],
    projects: [
      {
